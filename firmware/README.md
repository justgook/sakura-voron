...
- `vivid/`: BTT vendor-tested ViViD and buffer firmware; see its README. These are the documented exception to the common Klipper commit because the constrained buffer needs a vendor-reduced build.
